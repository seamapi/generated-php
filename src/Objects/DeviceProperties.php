...
class DeviceProperties
{
    ...
    public static function from_json(mixed $json): DeviceProperties|null
    {
        ...
        return new self(
            ...
            battery: DeviceBattery::from_json($json->battery) ?? null,
            ...
            august_metadata: DeviceAugustMetadata::from_json($json->august_metadata) ?? null,
            avigilon_alta_metadata: DeviceAvigilonAltaMetadata::from_json($json->avigilon_alta_metadata) ?? null,
            schlage_metadata: DeviceSchlageMetadata::from_json($json->schlage_metadata) ?? null,
            smartthings_metadata: DeviceSmartthingsMetadata::from_json($json->smartthings_metadata) ?? null,
            lockly_metadata: DeviceLocklyMetadata::from_json($json->lockly_metadata) ?? null,
            nuki_metadata: DeviceNukiMetadata::from_json($json->nuki_metadata) ?? null,
            kwikset_metadata: DeviceKwiksetMetadata::from_json($json->kwikset_metadata) ?? null,
            salto_metadata: DeviceSaltoMetadata::from_json($json->salto_metadata) ?? null,
            genie_metadata: DeviceGenieMetadata::from_json($json->genie_metadata) ?? null,
            brivo_metadata: DeviceBrivoMetadata::from_json($json->brivo_metadata) ?? null,
            igloo_metadata: DeviceIglooMetadata::from_json($json->igloo_metadata) ?? null,
            noiseaware_metadata: DeviceNoiseawareMetadata::from_json($json->noiseaware_metadata) ?? null,
            minut_metadata: DeviceMinutMetadata::from_json($json->minut_metadata) ?? null,
            four_suites_metadata: DeviceFourSuitesMetadata::from_json($json->four_suites_metadata) ?? null,
            two_n_metadata: DeviceTwoNMetadata::from_json($json->two_n_metadata) ?? null,
            controlbyweb_metadata: DeviceControlbywebMetadata::from_json($json->controlbyweb_metadata) ?? null,
            ttlock_metadata: DeviceTtlockMetadata::from_json($json->ttlock_metadata) ?? null,
            seam_bridge_metadata: DeviceSeamBridgeMetadata::from_json($json->seam_bridge_metadata) ?? null,
            igloohome_metadata: DeviceIgloohomeMetadata::from_json($json->igloohome_metadata) ?? null,
            nest_metadata: DeviceNestMetadata::from_json($json->nest_metadata) ?? null,
            ecobee_metadata: DeviceEcobeeMetadata::from_json($json->ecobee_metadata) ?? null,
            hubitat_metadata: DeviceHubitatMetadata::from_json($json->hubitat_metadata) ?? null,
            dormakaba_oracode_metadata: DeviceDormakabaOracodeMetadata::from_json($json->dormakaba_oracode_metadata) ?? null,
            wyze_metadata: DeviceWyzeMetadata::from_json($json->wyze_metadata) ?? null,
          ...
          $json->code_constraints ?? []
            ...
            keypad_battery: DeviceKeypadBattery::from_json($json->keypad_battery) ?? null,
            ...
            current_climate_setting: DeviceCurrentClimateSetting::from_json($json->current_climate_setting) ?? null,
            default_climate_setting: DeviceDefaultClimateSetting::from_json($json->default_climate_setting) ?? null,
            is_climate_setting_schedule_active: $json->is_climate_setting_schedule_active ?? null,
            active_climate_setting_schedule: DeviceActiveClimateSettingSchedule::from_json($json->active_climate_setting_schedule) ?? null,
            ...
            assa_abloy_credential_service_metadata: DeviceAssaAbloyCredentialServiceMetadata::from_json($json->assa_abloy_credential_service_metadata) ?? null,
        );
    }
